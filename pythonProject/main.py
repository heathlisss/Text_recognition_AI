...
# 3 = INFO, WARNING, and ERROR messages are not printedy
...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Dropout, Flatten, Dense, Reshape, LSTM, BatchNormalization
...
def emnist_model3():
    model = keras.Sequential()
    model.add(keras.Convolution2D(filters=32, kernel_size=(3, 3), padding='same', input_shape=(28, 28, 1), activation='relu'))
    model.add(keras.Convolution2D(filters=32, kernel_size=(3, 3), padding='same', activation='relu'))
    model.add(MaxPooling2D(pool_size=(2, 2)))
    model.add(Dropout(0.25))

    model.add(keras.Convolution2D(filters=64, kernel_size=(3, 3), padding='same', activation='relu'))
    model.add(keras.Convolution2D(filters=64, kernel_size=(3, 3), padding='same', activation='relu'))
